...
let person_name = "Mirza mahad baig"
...
let author = "Alber Einstein"           // storing the name in a variable
...
console.log(5+3);           //performing addition
console.log(10-2);
console.log(4*2);
console.log(16/2);
...
// specific to write because your programs are too simple at this point, just add your name and the current date at the top of each program 
